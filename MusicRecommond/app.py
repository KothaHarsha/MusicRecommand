...
def fetch_poster(music_title):
    response = requests.get("https://saavn.me/search/songs?query={}kun+f".format(music_title))
    data = response.json()
...
music_dict = pickle.load(open(r'C:\Users\Harsha\musicrec.pkl', 'rb'))
music = pd.DataFrame(music_dict)

similarity = pickle.load(open(r'C:\Users\Harsha\similarities.pkl', 'rb'))
